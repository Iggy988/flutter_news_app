...
class GlobalMethods {
  ...
  static String formattedDateText(String publishedAt) {
    ...
    String formattedDate = DateFormat('dd-MM-yyyy hh:mm:ss').format(parsedData);
    DateTime publishedDate =
        DateFormat('dd-MM-yyyy hh:mm:ss').parse(formattedDate);
    return '${publishedDate.day}/${publishedDate.month}/${publishedDate.year} ON ${publishedDate.hour}:${publishedDate.minute}';
  }

  // metoda za prikazivanje  Error Dialoga
  // treba da bude static da se moze access dierectly from name of this class
